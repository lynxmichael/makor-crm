...
export class PaymentsService {
  ...
  async create(dto: CreatePaymentDto) {
    ...
    if (alreadyPaid + dto.amount > invoiceTotal) {
      throw new BadRequestException('Le montant dépasse le solde restant.');
    }
  ...
  async validatePayment(id: string) {
    ...
    await this.auditService.create({
      ...
      entity: 'Payment',
      entityId: id,
      description: `Encaissement ${payment.reference} validé (${payment.amount.toString()} XOF)`,
    });
